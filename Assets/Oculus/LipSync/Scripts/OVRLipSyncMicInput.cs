...
public class OVRLipSyncMicInput : MonoBehaviour
{
    ...
    //Public
    public AudioClip recordedClipLS;
    ...
    public void InitializeMicrophone()
    {
        ...
        Debug.Log("inicio el microphonr");
        micSelected = true;
        GetMicCaps();
        initialized = true;
    }
    ...
    public void StartMicrophone()
    {
        ...
        //Starts recording
         //recordedClipLS = Microphone.Start(selectedDevice, true, 1, micFrequency);
         audioSource.clip = Microphone.Start(selectedDevice, true, 1, micFrequency);
        Debug.Log("startmicrofhone");
