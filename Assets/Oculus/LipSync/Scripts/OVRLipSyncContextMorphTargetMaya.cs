...
public class OVRLipSyncContextMorphTargetMaya : MonoBehaviour
{
    ...
    void CheckForKeys()
    {
        if (enableVisemeTestKeys)
        {
            ...
            {
                CheckVisemeKey(visemeTestKeys[i], i, VocaTamaño);
            }
        }
    ...
    void CheckLaughterKey()
    {
        ...
        {
            lipsyncContext.SetLaughterBlend(VocaTamaño);
        }
